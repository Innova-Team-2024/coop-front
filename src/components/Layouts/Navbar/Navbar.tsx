...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 shadow-sm bg-white">
      {/* 1) DIV de ancho completo con el gradiente */}
      <div className="bg-gradient-to-r from-blue-100 to-white w-full">
        {/* 2) El NAV centrado, con max-w */}
        <nav className="max-w-[1440px] mx-auto flex items-center justify-between
                        px-6 md:px-[120px] py-[24px] h-[72px] md:h-[103px] relative"
        >
