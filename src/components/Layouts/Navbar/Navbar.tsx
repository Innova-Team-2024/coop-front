    ...
    <header className="fixed top-0 left-0 w-full z-50">
      <nav className="w-full bg-[#e6e6e6] md:bg-white/80 backdrop-blur-[12px] shadow-none md:shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
        ...
        >
          ...
          {isClient && (
            <ul
              className="hidden md:flex gap-4 items-center flex-wrap min-w-0 text-[18px] leading-[24px] font-normal text-black relative z-10"
              ref={dropdownRef}
            >
              ...
              <li
                onClick={() =>
                  setOpenMenu(
                    openMenu === "formasdepago" ? null : "formasdepago"
                  )
                }
