...
export const metadata: Metadata = {
  title: "Iniciar sesión | Cooperativa Telefónica de Grand Bourg y Pablo Nogués",
  description:
    "Accedé al panel exclusivo para administradores con tu usuario y contraseña de la Cooperativa Telefónica de Grand Bourg y Pablo Nogués.",
};
  ...
  return (
    <main className="mt-16 lg:mt-0 lg:pt-0 pt-20 min-h-screen lg:grid lg:grid-cols-2">
      ...
      <section className="w-72 h-11 mx-auto opacity-75 lg:hidden">
        <Image src={isologoform} alt="Logo Cooperativa Telefónica" priority />
      </section>
      ...
      <section className="flex flex-col justify-center px-8 lg:px-24 py-12 bg-[#f4f4fb] -mt-5">
        <div className="space-y-4 text-center lg:hidden">
          ...
          <p className="text-[#232527] text-base leading-5">
            Accedé al panel para administradores <br />
            con tu usuario y contraseña.
          </p>
        </div>
        <div>
