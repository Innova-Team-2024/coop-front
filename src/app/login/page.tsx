...
export default function Login() {
    return (
        <main className="mt-16 lg:mt-0 lg:pt-0 pt-20 min-h-screen lg:grid lg:grid-cols-2">
            ...
            <section className="flex flex-col justify-center px-8 lg:px-24 py-12 bg-white ">
...
- tener en cuenta que los campos en los formularios tienen que estar validados (inputs)
- si necesito imagenes pedir al equipo de diseño
*/
