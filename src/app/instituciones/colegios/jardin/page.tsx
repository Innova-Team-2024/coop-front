...
export default function JardinPage() {
  ...
  return (
    <main>
      ...
      {/* Sección NOSOTROS */}
      <section id="nosotros-jardin" className="scroll-mt-20">
        <NosotrosSection
      ...
      {/* Sección ARANCELES */}
      <section id="aranceles-jardin" className="scroll-mt-20">
        <ArancelesCard
          titulo="Aranceles"
          matricula="$ 25.000"
          cuotaActual="$ 35.000"
      ...
      <section id="contacto-jardin" className="mt-[100px] scroll-mt-20">
        <ContactForm
      ...
      <section id="redes-jardin" className="mt-[80px] scroll-mt-20">
        <SocialMediaSection
