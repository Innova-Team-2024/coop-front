...
Envianos tu consulta!`}
      ...
      {/* Sección NOSOTROS */}
      <section id="nosotros-primaria" className="scroll-mt-20">
        <NosotrosSection
      ...
      {/* Sección ARANCELES */}
      <section id="aranceles-primaria" className="scroll-mt-20">
        <ArancelesCard
          titulo="Aranceles"
          matricula="$ 25.000"
          cuotaActual="$ 35.000"
      ...
      {/* Sección INSCRIPCIÓN / CONTACTO */}
      <section id="contacto-primaria" className="mt-[100px] scroll-mt-20">
        <ContactForm
      ...
      <section id="redes-primaria" className="mt-[80px] scroll-mt-20">
        <SocialMediaSection
