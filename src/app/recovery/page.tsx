...
export const metadata: Metadata = {
  title: "Recuperar contraseña | Cooperativa Telefónica de Grand Bourg y Pablo Nogués",
  description:
    "Restablecé tu contraseña ingresando el correo registrado. Te guiaremos para cambiarla de forma inmediata.",
};
  ...
  return (
    <main className="mt-16 lg:mt-0 lg:pt-0 pt-20 min-h-screen lg:grid lg:grid-cols-2 bg-[#f4f4fb]">
      ...
      <section className="flex flex-col justify-center px-8 lg:px-24 py-12 bg-[#f4f4fb] -mt-5">
        ...
        <div>
          <RecoverPasswordForm email={""} newPassword={""} confirmPassword={""} />
        </div>
      </section>
    </main>
  );
